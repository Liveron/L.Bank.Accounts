...
[UsedImplicitly]
public sealed class GetManyAccountStatementsQueryValidator 
    : AbstractValidator<GetManyAccountStatementsQuery>
{
    public GetManyAccountStatementsQueryValidator()
    {
        RuleFor(q => q.OwnerId)
            .NotEmpty()
